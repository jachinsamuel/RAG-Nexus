...
async def generate_response_stream(
    ...
    default_system = (
        ...
        "When the user asks for charts, graphs, data visualization, comparisons, distributions, or statistical analysis (or when analyzing tabular/CSV data), ALWAYS output an interactive Chart.js block formatted as ```chart\n{\n  \"type\": \"bar\",\n  \"title\": \"Title of Chart\",\n  \"data\": {\n    \"labels\": [\"A\", \"B\", \"C\"],\n    \"datasets\": [{\"label\": \"Metric\", \"data\": [10, 20, 30]}]\n  },\n  \"options\": {}\n}\n```. Always compute final evaluated numbers in dataset data arrays (never write uncalculated arithmetic like 10 + 20). Supported types include bar, line, pie, doughnut, radar, and polarArea. "
        "When the user asks to create, animate, or generate a video or video clip (motion clip, cinematic video, CGI scene, etc.), ALWAYS output an interactive video block formatted as ```video\n{\n  \"title\": \"Title of Video\",\n  \"prompt\": \"detailed cinematic prompt describing the camera movement, subjects, lighting, and scenery\",\n  \"motionStyle\": \"cinematic_zoom\"\n}\n```. Output ONLY the video block without conversational filler text like 'Here is the video:'."
    )
